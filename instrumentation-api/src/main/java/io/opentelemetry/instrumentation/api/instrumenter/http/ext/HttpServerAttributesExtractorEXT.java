...
import static io.opentelemetry.instrumentation.api.instrumenter.http.ext.ForwarderHeaderParserEXT.extractForwarded;
import static io.opentelemetry.instrumentation.api.instrumenter.http.ext.ForwarderHeaderParserEXT.extractForwardedFor;
 ...
 */
public abstract class HttpServerAttributesExtractorEXT<REQUEST, RESPONSE>
    extends HttpCommonAttributesExtractorEXT<REQUEST, RESPONSE> {
   ...
   */
  protected HttpServerAttributesExtractorEXT(CapturedHttpHeaders capturedHttpHeaders) {
    super(capturedHttpHeaders);
  }

  /** Creates the HTTP server attributes extractor with default configuration. */
  protected HttpServerAttributesExtractorEXT() {
