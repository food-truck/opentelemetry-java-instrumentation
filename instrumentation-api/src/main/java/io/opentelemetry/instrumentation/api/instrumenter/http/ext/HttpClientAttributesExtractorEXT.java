 ...
 */
public abstract class HttpClientAttributesExtractorEXT<REQUEST, RESPONSE>
   ...
   */
  protected HttpClientAttributesExtractorEXT(CapturedHttpHeaders capturedHttpHeaders) {
    super(capturedHttpHeaders);
  }

  /** Creates the HTTP client attributes extractor with default configuration. */
  protected HttpClientAttributesExtractorEXT() {
